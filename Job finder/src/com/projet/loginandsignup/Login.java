...
private void dashboard() {// GEN-FIRST:event_jButton2ActionPerformed
    ...
    private static boolean checkLogin(String username, String password) {
        try (Connection connection = DatabaseConnection.connectToDatabase();) {
            ...
            JOptionPane.showMessageDialog(null, "Error during database query: " + e.getMessage());
            return false;
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Hello Everyone!");
