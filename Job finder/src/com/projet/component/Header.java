...
public class Header extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttonBadges1 = new com.projet.swing.ButtonBadges();
        buttonBadges2 = new com.projet.swing.ButtonBadges();

        buttonBadges1.setBackground(new java.awt.Color(25, 25, 25));
        buttonBadges1.setForeground(new java.awt.Color(25, 25, 25));
        buttonBadges1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/projet/icon/noti.png"))); // NOI18N
        buttonBadges1.setAutoscrolls(true);

        buttonBadges2.setBackground(new java.awt.Color(25, 25, 25));
        buttonBadges2.setForeground(new java.awt.Color(25, 25, 25));
        buttonBadges2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/projet/icon/message.png"))); // NOI18N
    ...
    private com.projet.swing.ButtonBadges buttonBadges1;
    private com.projet.swing.ButtonBadges buttonBadges2;
