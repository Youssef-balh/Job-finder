...
public class Info extends javax.swing.JFrame {
    ...
    public void get_data(String url) {
        String query = "SELECT * FROM rekrute_jobs WHERE url = ?";
        ...
        try (Connection connection = DatabaseConnection.connectToDatabase(); PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    String date = resultSet.getString("date_de_publication");
                    String type = resultSet.getString("type_de_contrat");
                    String experience = resultSet.getString("experience");
                    String region = resultSet.getString("region");
                    String description = resultSet.getString("description");
                    String profil = resultSet.getString("profil_recherche");
                    ...
                    String date_postulation = resultSet.getString("date_post_max");
                    ...
                    jLabel22.setText(competence);
                    jLabel24.setText(entreprise);
                    jLabel23.setText(date_postulation);
    ...
    private void initComponents() {
        ...
        imageAvatar2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/projet/icon/rekrute.jpg"))); // NOI18N
        ...
        roundPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, roundPanel9Layout.createSequentialGroup()
                ...
                .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 1009, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(51, 51, 51))
        );
        ...
        jLabel23.setText("Date de postulation");
        ...
        roundPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, roundPanel10Layout.createSequentialGroup()
                ...
                .addGroup(roundPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(roundPanel9, javax.swing.GroupLayout.PREFERRED_SIZE, 1025, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(roundPanel10Layout.createSequentialGroup()
                        .addGap(152, 152, 152)
        ...
        roundPanel10Layout.setVerticalGroup(
            ...
            .addGroup(roundPanel10Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(roundPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(imageAvatar2, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(roundPanel10Layout.createSequentialGroup()
