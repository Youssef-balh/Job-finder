...
import static com.projet.table.Test.removeRowsWithNullAndEmptyValues_emploi;
import static com.projet.table.Test.removeRowsWithNullAndEmptyValues_mjob;
import static com.projet.table.Test.removeRowsWithNullAndEmptyValues_rekrute;
...
public class Graphe extends javax.swing.JFrame {
    ...
    boolean check2 ;
    boolean check3 ;
    public Graphe(boolean check1 ,boolean check2 ,boolean check3 ) {
        initComponents();
            ...
            if (m_job) {
                try (PreparedStatement statement = connection.prepareStatement(sql1)) {
                    try (ResultSet resultSet = statement.executeQuery()) {
                        ...
                        chart.addData(new ModelChart("m_job.ma", new double[]{countBac, countBac1, countBac2, countBac3, countBac4, countBac5Plus, countNivBacEtMoins}));
                    }
                }
            }
            if (rekrute_jobs) {
                try (PreparedStatement statement = connection.prepareStatement(sql2)) {
                    try (ResultSet resultSet = statement.executeQuery()) {
                        ...
                        // Add data to the chart based on the boolean parameter
                        chart.addData(new ModelChart("rekrute.ma", new double[]{countBac, countBac1, countBac2, countBac3, countBac4, countBac5Plus, countMoinsBac}));
            ...
            if (executeSql2) {
                ...
                try (PreparedStatement statement = connection.prepareStatement(sql2)) {
                    try (ResultSet resultSet = statement.executeQuery()) {
                        ...
                        chart2.addData(new ModelChart("Emploi_ma", new double[]{cdiCount, cddCount, lettreCount, other}));
                    }
                }
            ...
            if (executeSql2) {
                ...
                try (PreparedStatement statement = connection.prepareStatement(sql2)) {
                    try (ResultSet resultSet = statement.executeQuery()) {
                        ...
                        // Create a single ModelChart instance after fetching the data from sql2
                        chart3.addData(new ModelChart("Emploi_ma", new double[]{Ing, Tech, Cons, Man, Comp, Gest, other}));
                    }
                }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(chart3, javax.swing.GroupLayout.DEFAULT_SIZE, 782, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
          public void run() {
            ...
            test.fetch_DataAndPopulateChart(check2, check3, check1);
            test.fetchDataAndPopulateChart(check2, check3, check1);
            test.populateData(check2, check3, check1);
